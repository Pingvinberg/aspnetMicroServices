...
namespace Discount.Grpc.Services
{
    public class DiscountService : DiscountProtoService.DiscountProtoServiceBase
    {
        ...
        public override async Task<DeleteDiscountResponse> DeleteDiscount(DeleteDiscountRequest request, ServerCallContext context)
        {
            ...
            if(deleted == false)
            {
                throw new RpcException(new Status(StatusCode.NotFound, $"Discount with ProductName={request.ProductName} failed to be removed."));
                
            }
            _logger.LogInformation("Discount is succesfully removed. ProductName : {ProductName}", request.ProductName);
